...
public class MapTaskCompletionEventsUpdate implements Writable {
  ...
  NewPartitionAddedEvent npaEvent;
  boolean reset;
  ...
  public MapTaskCompletionEventsUpdate(TaskCompletionEvent[] events,
	      NewPartitionAddedEvent npe, boolean reset) {
	    this.events = events;
	    this.reset = reset;
	    this.npaEvent = npe;
	  }
  ...
  public NewPartitionAddedEvent getNewPartitionAddedEvent(){
	  return npaEvent;
  }
  ...
  public void write(DataOutput out) throws IOException {
    ...
    if(npaEvent == null)
    	npaEvent = new NewPartitionAddedEvent();
    npaEvent.write(out);
